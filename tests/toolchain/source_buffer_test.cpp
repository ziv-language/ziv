...
protected:
    ...
    void SetUp() override {
        ...
        fs.addFile("/test/valid.ziv", 0, llvm::MemoryBuffer::getMemBuffer("test content"));
        fs.addFile("/test/valid.z", 0, llvm::MemoryBuffer::getMemBuffer("another test"));
        fs.addFile("/test/invalid.txt", 0, llvm::MemoryBuffer::getMemBuffer("invalid file"));
        fs.addFile("/test/empty.ziv", 0, llvm::MemoryBuffer::getMemBuffer(""));
    }
};
