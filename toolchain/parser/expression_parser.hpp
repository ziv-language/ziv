...
ziv::toolchain::ast::AST::Node Parser::parse_equality() {
    ...
    while (consume_match(ziv::toolchain::lex::TokenKind::DoubleEquals())
           || consume_match(ziv::toolchain::lex::TokenKind::NotEquals())) {
        auto operator_token = previous();
...
ziv::toolchain::ast::AST::Node Parser::parse_comparison() {
    ...
    while (consume_match(ziv::toolchain::lex::TokenKind::Less())
           || consume_match(ziv::toolchain::lex::TokenKind::LessEquals())
           || consume_match(ziv::toolchain::lex::TokenKind::Greater())
           || consume_match(ziv::toolchain::lex::TokenKind::GreaterEquals())) {
        auto operator_token = previous();
...
ziv::toolchain::ast::AST::Node Parser::parse_addition() {
    ...
    while (consume_match(ziv::toolchain::lex::TokenKind::Plus())
           || consume_match(ziv::toolchain::lex::TokenKind::Minus())) {
        auto operator_token = previous();
...
ziv::toolchain::ast::AST::Node Parser::parse_multiplication() {
    ...
    while (consume_match(ziv::toolchain::lex::TokenKind::Star())
           || consume_match(ziv::toolchain::lex::TokenKind::Slash())
...
ziv::toolchain::ast::AST::Node Parser::parse_unary() {
    if (consume_match(ziv::toolchain::lex::TokenKind::Minus())
        || consume_match(ziv::toolchain::lex::TokenKind::Not())) {
        auto operator_token = previous();
...
ziv::toolchain::ast::AST::Node Parser::parse_primary() {
    if (match(ziv::toolchain::lex::TokenKind::IntLiteral())) {
        ...
        return ast_.add_node(ast::NodeKind::LiteralExpr(), consume());
    } else if (match(ziv::toolchain::lex::TokenKind::True())
